...
#define TRIGGER_PIN  10   // Arduino pin 10 tied to trigger pin on the ultrasonic sensor.
#define ECHO_PIN     11   // Arduino pin 11 tied to echo pin on the ultrasonic sensor.
